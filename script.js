...
const insertHowl = new Howl({src: ['mp3/insert.mp3'], volume: 0.2}); 
const swapHowl = new Howl({src: ['mp3/swap.mp3'], volume: 0.1}); 
const resetHowl = new Howl({src: ['mp3/reset.mp3'], volume: 0.2}); 
const slideHowl = new Howl({src: ['mp3/slide.mp3'], volume: 0.1}); 
const uploadHowl = new Howl({src: ['mp3/upload.mp3'], volume: 0.05}); 
const downloadHowl = new Howl({src: ['mp3/download.mp3'], volume: 0.02}); 
const callDeleteHowl = new Howl({src: ['mp3/callDelete.mp3'], volume: 0.3}); 
const callDeleteAllHowl = new Howl({src: ['mp3/callDeleteAll.mp3'], volume: 0.03}); 
const deleteHowl = new Howl({src: ['mp3/delete.mp3'], volume: 0.2}); 
const deleteAllHowl = new Howl({src: ['mp3/deleteAll.mp3'], volume: 0.1}); 
const undoHowl = new Howl({src: ['mp3/undo.mp3'], volume: 0.2}); 
const faultHowl = new Howl({src: ['mp3/fault.mp3'], volume: 0.2});
